...
public class CartServiceImpl implements CartService{
    ...
    public CartDTO addProductToCart(Long productId, Integer quantity) {
        ...
        if(product.getQuantity()<quantity){
            throw new APIException("Please enter quantity less than "+product.getQuantity());
        }
    ...
    public CartDTO updateProductQuantityIncart(Long productId, Integer quantity) {
        ...
        Product product = productRepository.findById(productId)                             
         ...
         if(newQuantity<0){
             throw new APIException("resulting quantiity cannot be negative");
         }
    ...
    public void updateProductInCarts(Long cartId, Long productId) {
        ...
        CartItem cartItem = cartItemRepository.findCartItemByProductIdAndCartId(cartId,productId);
        if(cartItem==null){
            throw new APIException("Product"+product.getProductName()+"no avaliable");
